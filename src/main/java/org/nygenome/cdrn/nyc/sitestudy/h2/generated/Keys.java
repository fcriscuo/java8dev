...
public class Keys {
    ...
    public static final UniqueKey<CohortStudySiteRecord> CONSTRAINT_E = UniqueKeys0.CONSTRAINT_E;
    ...
    public static final UniqueKey<CohortStudyMetaRecord> CONSTRAINT_B = UniqueKeys0.CONSTRAINT_B;

    // -------------------------------------------------------------------------
    // FOREIGN KEY definitions
    // -------------------------------------------------------------------------

    public static final ForeignKey<CohortStudySiteRecord, CohortStudyMetaRecord> CONSTRAINT_E1 = ForeignKeys0.CONSTRAINT_E1;
    public static final ForeignKey<CohortStudyPatientRecord, CohortStudyMetaRecord> CONSTRAINT_14 = ForeignKeys0.CONSTRAINT_14;
    public static final ForeignKey<StudyMapRecord, CohortStudyPatientRecord> CONSTRAINT_3 = ForeignKeys0.CONSTRAINT_3;
    public static final ForeignKey<StudyMapRecord, CohortStudySiteEhrRecord> CONSTRAINT_31 = ForeignKeys0.CONSTRAINT_31;
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        public static final UniqueKey<CohortStudySiteRecord> CONSTRAINT_E = createUniqueKey(CohortStudySite.COHORT_STUDY_SITE, "CONSTRAINT_E", CohortStudySite.COHORT_STUDY_SITE.COHORT_STUDY_SITE_ID);
        ...
        public static final UniqueKey<CohortStudyMetaRecord> CONSTRAINT_B = createUniqueKey(CohortStudyMeta.COHORT_STUDY_META, "CONSTRAINT_B", CohortStudyMeta.COHORT_STUDY_META.COHORT_STUDY_ID);
    }

    private static class ForeignKeys0 extends AbstractKeys {
        public static final ForeignKey<CohortStudySiteRecord, CohortStudyMetaRecord> CONSTRAINT_E1 = createForeignKey(org.nygenome.cdrn.nyc.sitestudy.h2.generated.Keys.CONSTRAINT_B, CohortStudySite.COHORT_STUDY_SITE, "CONSTRAINT_E1", CohortStudySite.COHORT_STUDY_SITE.COHORT_STUDY_ID);
        public static final ForeignKey<CohortStudyPatientRecord, CohortStudyMetaRecord> CONSTRAINT_14 = createForeignKey(org.nygenome.cdrn.nyc.sitestudy.h2.generated.Keys.CONSTRAINT_B, CohortStudyPatient.COHORT_STUDY_PATIENT, "CONSTRAINT_14", CohortStudyPatient.COHORT_STUDY_PATIENT.COHORT_STUDY_ID);
        public static final ForeignKey<StudyMapRecord, CohortStudyPatientRecord> CONSTRAINT_3 = createForeignKey(org.nygenome.cdrn.nyc.sitestudy.h2.generated.Keys.CONSTRAINT_1, StudyMap.STUDY_MAP, "CONSTRAINT_3", StudyMap.STUDY_MAP.SS_ID);
        public static final ForeignKey<StudyMapRecord, CohortStudySiteEhrRecord> CONSTRAINT_31 = createForeignKey(org.nygenome.cdrn.nyc.sitestudy.h2.generated.Keys.CONSTRAINT_5, StudyMap.STUDY_MAP, "CONSTRAINT_31", StudyMap.STUDY_MAP.SSS_ID);
    }
}
